...
class RetroMLP(TemplateModel):
    ...
    def __init__(self, fp_dim, hidden_dim, out_dim, templates=None, fp_types=FP.values(), layers=1, activation="elu",
    ...
    def encode_smiles(self, mol_smiles_list):
        return encode_smiles(mol_smiles_list, self.fp_dim, fp_types=self.fp_types)
